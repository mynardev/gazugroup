        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-16">
            <ul className="flex justify-center gap-6 sm:justify-end">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-primary transition hover:text-primary/65"
                >
            ...
            <div className="mt-16 sm:flex sm:items-center sm:justify-between">
              <div className="flex justify-center text-gray-700 sm:justify-start cursor-pointer">
                <a href="/">
                  <p className="font-semibold">GAZU Group s.r.o.</p>
                </a>
              </div>
